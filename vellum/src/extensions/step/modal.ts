 ...
 */
export function answering(state: WindowState | null, id: string | null): Asking {
 ...
 */
function keptOn(state: WindowState | null, on: Pending | null): Asking {
 ...
 */
function answeredOn(state: WindowState | null, id: string): Asking {
  const pending = pendingOf(state);
 ...
 * and no step follows.
 */
export function modalOf(state: WindowState | null, asking: Asking, approved: boolean): Modal {
...
export function dotOf(state: WindowState | null, asking: Asking): Pending | null {
  const pending = pendingOf(state);
