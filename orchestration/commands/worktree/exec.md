...
allowed-tools:
  - Bash("~/.claude/plugins/marketplaces/bengolea-plugins/orchestration/scripts/worktree/worktree":exec)
...
!"~/.claude/plugins/marketplaces/bengolea-plugins/orchestration/scripts/worktree/worktree" exec $ARGUMENTS
