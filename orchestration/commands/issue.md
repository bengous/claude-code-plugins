...
allowed-tools: ["Bash(~/.claude/plugins/marketplaces/bengolea-plugins/orchestration/scripts/issue/issue:*)"]
...
!"~/.claude/plugins/marketplaces/bengolea-plugins/orchestration/scripts/issue/issue" list $ARGUMENTS
