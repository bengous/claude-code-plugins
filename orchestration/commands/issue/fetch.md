...
argument-hint:
allowed-tools:
  - Bash("~/.claude/plugins/marketplaces/bengolea-plugins/orchestration/scripts/issue/issue":fetch)
...
!"~/.claude/plugins/marketplaces/bengolea-plugins/orchestration/scripts/issue/issue" fetch $ARGUMENTS
