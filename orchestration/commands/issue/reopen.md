...
allowed-tools:
  - Bash("~/.claude/plugins/marketplaces/bengolea-plugins/orchestration/scripts/issue/issue":reopen)
...
!"~/.claude/plugins/marketplaces/bengolea-plugins/orchestration/scripts/issue/issue" reopen $ARGUMENTS
