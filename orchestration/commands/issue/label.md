...
allowed-tools:
  - Bash("~/.claude/plugins/marketplaces/bengolea-plugins/orchestration/scripts/issue/issue":label)
...
!"~/.claude/plugins/marketplaces/bengolea-plugins/orchestration/scripts/issue/issue" label $ARGUMENTS
