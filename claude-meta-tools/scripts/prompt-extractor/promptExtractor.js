/**
 * Prompt Extractor - Extracts system prompts from Claude Code's cli.js
 *
 * Vendored from: https://github.com/Piebald-AI/tweakcc
 * Copyright (c) 2025 Piebald LLC - MIT License
 *
 * Requires: @babel/parser (installed in isolated environment at runtime)
 */
...
if (require.main === module) {
  ...
  if (!filepath) {
    console.error(
      'Usage: node promptExtractor.js <path-to-cli.js> [output-file]'
    );
    process.exit(1);
  }
