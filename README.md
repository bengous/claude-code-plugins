...
| [claude-meta-tools](claude-meta-tools/) | 2.0.0 | Meta-tools for Claude Code: maintain documentation (CLAUDE.md sync), prompt coaching/auditing, research, concept demystification, and extend Claude capabilities |
