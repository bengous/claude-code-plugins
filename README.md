...
|--------|---------|-------------|
| [claude-orchestration](orchestration/) | 2.6.0 | Parallel multi-agent orchestration for complex features with git-wt --stack worktree isolation |
...
| [claude-meta-tools](claude-meta-tools/) | 1.14.0 | Meta-tools for Claude Code: maintain documentation (CLAUDE.md sync), prompt coaching/auditing, research, concept demystification, and extend Claude capabilities |
...
| [ship](ship/) | 1.0.0 | Ship feature branches: strip working files, create PRs, merge to main with GPG signing and squash support |
