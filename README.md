...
| [repo-bootstrap](repo-bootstrap/) | 1.0.1 | One-shot repo setup: the dev-trunk/main-release linear model, branches migrated to submodules with GitHub Actions sync |
