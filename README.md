...
| [claude-meta-tools](claude-meta-tools/) | 1.15.1 | Meta-tools for Claude Code: maintain documentation (CLAUDE.md sync), prompt coaching/auditing, research, concept demystification, and extend Claude capabilities |
...
| [agents-bridge](agents-bridge/) | 1.8.0 | Bridge to the OpenAI Codex CLI for cross-model collaboration |
