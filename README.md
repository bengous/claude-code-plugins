...
| [git-history](git-history/) | 1.0.0 | Local history without an editor: commit, commit closing an issue, interactive rebase, squash by pattern or hash |
| [github-flow](github-flow/) | 1.0.0 | GitHub lifecycle through gh: agent-ready issues, review-ready PRs with attached images, issue and PR triage, CI-gated linear merge |
