...
| [git](git/) | 1.0.2 | Local history without an editor: commit with an optional issue-closing trailer, interactive rebase, squash by pattern or hash |
| [github-flow](github-flow/) | 1.1.0 | GitHub lifecycle through gh: agent-ready issues, review-ready PRs with attached images, issue and PR triage, CI-gated linear merge, commit-push-PR in one step |
