...
Run `/claude-api prompt-audit <path to SKILL.md>` on the completed SKILL.md. It reports dated prompting patterns with a proposed diff.

If the claude-api skill isn't available, manually verify:
